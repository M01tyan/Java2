...
public class ToyBoxTest {/* Parameter with bounded wildcard to accept Toy and its subclasses*/
    public static void showToysinBox(ToyBox<? extends Toy> box) {
        for(int i=0; i<box.getSize(); i++){    // Complete showAnimalsinToyBox method with proper argument and method body
